...
## upload SWE
#parameter = "SWE"
#output_filename_nc = 'SWE_{formatted_date}.nc' # important not written to spatial directory
#bundle_nc_files(directory, formatted_date, parameter, output_filename_nc)
...
## upload HS
#parameter = "HS"
#output_filename_nc = 'HS_{formatted_date}.nc' # important not written to spatial directory
#bundle_nc_files(directory, formatted_date, parameter, output_filename_nc)
...
## upload ROF
#parameter = "ROF"
#output_filename_nc = 'ROF_{formatted_date}.nc' # important not written to spatial directory
#bundle_nc_files(directory, formatted_date, parameter, output_filename_nc)
